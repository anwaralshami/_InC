                      ...
                      tabPanel(
                          ...
                          tabsetPanel(
                              ...
                              tabPanel(
                                  ...
                                  sidebarPanel(
                                      actionButton("clickdiv", h5("Generate a new Activity Input File")),
                                      fileInput("activityData", h4(" Or "),
                                      ...
                                      bsModal("modalExample", "Generate Activity Input File", "clickdiv", size = "large",
                                              ...
                                              dashboardPage(
                                                ...
                                                dashboardSidebar(collapsed = F,
                                                                 sidebarMenu(
                                                                   menuItem("General Parameters", tabName = "genPam"),
                                                                   menuItem("Activity Definitintion", tabName = "actDef"),
                                                                   menuItem("Download input file", tabName = "DLfile")
